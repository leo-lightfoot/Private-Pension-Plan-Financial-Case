...
| Asset                     | Weight (%)   | Individual Return (%)   | Individual Volatility (%)   |
|:--------------------------|:-------------|:------------------------|:----------------------------|
| Core_MSCI_World_ETF       | 47.1%        | 13.11%                  | 15.70%                      |
| Invesco_Physical_Gold_ETF | 52.9%        | 12.80%                  | 14.64%                      |

### 🔍 Key Allocation Insights

- **Largest Position**: Invesco_Physical_Gold_ETF (52.9%)
- **Most Diversified**: Portfolio includes 2 major positions (>5%)
- **Concentration**: Top 3 positions represent 100.0% of portfolio
